...
public class Password {
    ...
    private static final String SECRET_KEX_FACTORY_ALGORITHM = "PBKDF2WithHmacSHA1";
    ...
    public static byte[] generatePasswordHash(String password, byte[] salt) throws NoSuchAlgorithmException, InvalidKeySpecException {
        final SecretKeyFactory secretKeyFactory = SecretKeyFactory.getInstance(SECRET_KEX_FACTORY_ALGORITHM);
